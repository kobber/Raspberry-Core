...
##  Q10: The pack launches and loads until 99%, but then it freezes up! What's wrong?
  ...
  ##  Q11: How do I install / use shaders with this modpack?

  A: It's fairly simple - installing the Oculus mod (and disabling Rubidium which gets auto-installed alongside Oculus) is the first step - you can find a semi-official guide made by \@nöelle for setting up shaders by [clicking here](https://moddedmc.wiki/en/project/raspberry-core/docs/rf/shaders)!

## **Q12: Can I update my world from an old/previous version of the pack to the latest version?**
...
## **Q13: Does this modpack have/will this modpack update to Create 6.0?**
A: Unfortunately no, RF is only available on Minecraft 1.19.2, and Create 6.0 is only available on versions 1.20.1 and 1.21.1 - it's highly unlikely that the Create update will be backported to 1.19.2 as it's a nearly 3-year-old version of Minecraft.