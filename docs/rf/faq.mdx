...
**hey\! got a question about the pack? chances are, it's one that gets frequently asked \- see if any of these answers are what you need, and you can ask further questions in [the discord](https://discord.gg/jxNe26WNYh) if you have any**
...
## **Q2: how do i play with friends/where is the server pack?**
  A: for the current, latest release, you can find the server pack made by @Cassian by clicking [here\!](server) it is actively updated and maintained for every release, though do be patient whenever a new release is out, the server pack may not update immediately alternatively, you can use either [**essential**](https://modrinth.com/mod/essential/versions?g=1.19.2&l=forge) or [**world host**](https://modrinth.com/mod/world-host/version/0.5.1+1.19.2-forge) to play together with friends without any server setup, though do keep in mind that this is more of a quick and dirty method, and is not fully supported
