...
public class ClothConfigFactory {
    ...
    public static Screen create(Screen parent) {
        ...
        ConfigCategory overlayCategory = builder.getOrCreateCategory(Component.translatable("config.raspberry.overlay"));
        ...
        for (var field : ModConfig.class.getFields()) {
            ...
            else if (field.getName().contains("overlay")) category = overlayCategory;
